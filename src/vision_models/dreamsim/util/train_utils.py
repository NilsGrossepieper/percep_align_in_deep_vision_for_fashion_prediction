"""
train_utils.py — small training helpers.

- HingeLoss: margin-based hinge loss for 2AFC logits (larger logit = prefers right).
- seed_worker: per-worker seeding for reproducible DataLoader workers.
- clear_logging: quiet down Lightning’s verbose loggers for cleaner output.
- Mean: streaming mean metric with distributed-safe accumulation.
"""
